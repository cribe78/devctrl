...
export class TableController {
    ...
    static $inject = [ 'DataService', 'RecordEditorService'];
...
export let TableComponent : angular.IComponentOptions = {
...
export class TableComponentNg2 extends UpgradeComponent {
    @Input()tableName;

    constructor(elementRef: ElementRef, injector: Injector) {
        super('devctrlTable', elementRef, injector);
    }
}