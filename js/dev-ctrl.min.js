...
io(l.protocol()+"://"+l.host()),m=f({ioSocket:t}),v={},n={};f={editEnabled:!0};"undefined"!==typeof b.localStorage&&(t=b.localStorage.config,angular.isString(t)?f=JSON.parse(t):b.localStorage.config=JSON.stringify(f));var g={config:f,messenger:m,dataModel:h,schema:p,addRow:function(a,b){c.post("data.php",a).then(function(c){var d=Object.keys(c.data.add[a.tableName])[0];console.log("new record "+d+"added to "+a.tableName);g.loadData(c.data);c=h[a.tableName].indexed[d];angular.forEach(a,function(b,
c){"table"!=c&&(a[c]=null)});angular.isFunction(b)&&b(c)},function(a){g.errorToast(a.data)})},dialogClose:function(){k.hide()},deleteRow:function(a){var b="data.php/"+a.tableName+"/"+a.id,d=!1;angular.forEach(a.referenced,function(a,b){0<Object.keys(a).length&&(d=b)});d?g.errorToast({error:"Cannot delete "+a.tableName+" record due to foreign key constraint on "+d}):c.delete(b).success(function(a){g.loadData(a)}).error(function(a){g.errorToast(a)})},editEnum:function(a,b,c,d){angular.isObject(d)||
(d={});k.show({targetEvent:a,locals:{myEnum:b,enumRefRecord:c,options:d},controller:DevCtrl.EnumEditor.Ctrl,controllerAs:"editor",bindToController:!0,templateUrl:"ng/enum-editor.html",clickOutsideToClose:!0,hasBackdrop:!1})},editRecord:function(a,b,c,d){"0"!==b?b=g.getRowRef(c,b):(b=g.getNewRowRef(c),angular.isObject(d)&&angular.merge(b.fields,d));k.show({targetEvent:a,locals:{obj:b},controller:DevCtrl.Record.Ctrl,controllerAs:"record",bindToController:!0,templateUrl:"ng/record.html",clickOutsideToClose:!0,
...
(0-d))*(b-d)/100};this.updateValue=function(b){a.updateControlValue(c.ctrl)};this.editOptions=function(b){a.editEnum(b,null,c.ctrl,{title:"Edit "+c.name+" options"})};this.selectMenuItem=function(a){c.ctrl.fields.value=a;c.updateValue()};this.selectOptions=function(){var a=c.ctrl.fields.enum_id,b={};0<a&&(b=c.enums.indexed[a].referenced.enum_vals);return b};this.selectValueName=function(){var a=c.selectOptions(),b=c.ctrl.fields.value,d="";angular.forEach(a,function(a){a.fields.value==b&&(d=a.fields.name)});
