...
controllerAs:"table",resolve:DevCtrl.Table.Resolve,data:{title:"Table Editor"}});b.when("/","/rooms");d.html5Mode(!0)}]};DevCtrl.Common={};DevCtrl.Common.Resolve={loadControls:function(a){return a.getTablePromise("controls")},loadControlTemplates:function(a){return a.getTablePromise("control_templates")},loadRooms:function(a){return a.getTablePromise("rooms")},loadPanels:function(a){return a.getTablePromise("panels")},loadPanelControls:function(a){return a.getTablePromise("panel_controls")},loadControlSets:function(a){return a.getTablePromise("control_sets")}};DevCtrl.Room={};
DevCtrl.Room.Ctrl=["$stateParams","DataService",function(a,d){var b=this;this.roomName=a.name;this.rooms=d.getTable("rooms");angular.forEach(this.rooms.listed,function(a){a.fields.name==b.roomName&&(b.obj=a,b.id=a.id)});this.panels=this.obj.referenced.panels;this.panelControls=function(a){if(angular.isDefined(a.referenced.panel_controls))return a.referenced.panel_controls};this.togglePanel=function(a){angular.isDefined(a.opened)?a.opened=!a.opened:a.opened=!0};this.isPanelOpen=function(a){return angular.isDefined(a.opened)&&a.opened}}];DevCtrl.MainCtrl=["$state","$mdSidenav","DataService","MenuService",function(a,d,b,e){this.msg="Hello World!";this.tiles=[{img:"/images/orc.png"},{img:"/images/pict.png"},{img:"/images/sage.png"}];this.$state=a;this.schema=b.schema;this.menu=e;this.control_endpoints=b.getTable("control_endpoints");this.toggleSidenav=function(a){d(a).toggle()};this.go=function(b){angular.isString(b)?a.go(b):a.go(b.name,b.params)};this.dataModel=b.dataModel;this.title="DevCtrl";this.top=!0}];DevCtrl.Menu={};DevCtrl.Menu.Directive=["MenuService","$state",function(a,d){return{scope:!0,bindToController:{},controller:function(a,d){this.service=a},controllerAs:"menu",templateUrl:"ng/menu.html"}}];DevCtrl.DataService={};
